...
const portfolioItems = [
  ...
  { id: '02', title: 'Global Tech', category: 'Corporate', metric: '4.1x ROAS', img: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?auto=format&fit=crop&w=1200&q=80', description: "A full positioning and video communication system built to increase trust in a high-consideration enterprise offering. We aligned product value messaging with buyer-stage concerns, redesigned internal sales-support assets, and produced channel-specific storytelling content that helped accelerate deal velocity and improve conversion confidence across longer sales cycles." },
  { id: '03', title: 'Urban Lifestyle', category: 'Print & OOH', metric: '27% More Footfall', img: 'https://images.unsplash.com/photo-1558655146-d09347e92766?auto=format&fit=crop&w=1200&q=80', description: "A city-led print and OOH rollout engineered around neighborhood behavior, commuting patterns, and location-specific message relevance. The campaign combined high-contrast visual hierarchy with concise callouts tailored to each zone, resulting in stronger recall and a measurable lift in store visits across priority urban growth clusters." },
  { id: '04', title: 'Future Concepts', category: 'Animation', metric: '2.8x Demo Signups', img: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80', description: "An explainer-led narrative framework that translated a technically complex product into clear customer value through animated storytelling and staged information flow. By simplifying cognitive load at each decision point, improving feature-to-benefit mapping, and tightening landing-page context, the campaign reduced friction and significantly lifted qualified demo signups." },
];
